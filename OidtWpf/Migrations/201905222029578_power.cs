    ...
    public partial class power : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        udid = c.Guid(nullable: false, identity: true),
                        parametersGender = c.String(),
                        parametersAge = c.Int(nullable: false),
                        parametersCountry = c.String(),
                        spentMoney = c.Single(nullable: false),
                        earnedGameMoney = c.Double(nullable: false),
                        spentGameMoney = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.udid);
